...
def get_geodesics(integrator:Integrator, geodesics:list[Function], settings:VidSettings) -> list[Function]:
...
@njit(parallel=True, fastmath=True)
def get_colors(geodesics:list[Function], gas_vals:list[Function], settings:VidSettings,
               spec_ints:list[Function]) -> tuple[Function, np.ndarray]:
