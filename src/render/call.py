...
from Classes.GravField.grav_lib import Minkowski, Schwarzschild
# Minkowski().use()
...
scene = [Hittable(tag=HITTABLE_LIGHT,
         shape=Shape(pos=Vec(0,0,0), rot=(np.pi/2,-np.pi/20,0), tag=SHAPE_ANNULUS, r_in=1.5, r_out=5., height=0.1),
